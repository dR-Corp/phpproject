                ...
                <table id="datatable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?= $i++; ?></td>
                                <td><?= $licencier->getNom(); ?></td>
                                <td><?= $licencier->getPrenom(); ?></td>
                                <td>
                                    <?php
                                        $contact = $contactDAO->getById($licencier->getContactId());
                                        echo $contact['nomContact'].' '.$contact['prenomContact']
                                    ?>
                                </td>
                                <td><?= $licencier->getCategorie(); ?></td>
                                <td>
                                    <a href="edit-licencier-<?= $licencier->getNumeroLicence() ?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Modifier</a>
                                    <a href="delete-licencier-<?= $licencier->getNumeroLicence() ?>-<?= $licencier->getContactID() ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Supprimer</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
