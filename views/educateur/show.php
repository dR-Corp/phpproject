                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        $licencie = $licencierDAO->getByNumeroLicencier($educateur->getNumeroLicence()); 
                                        echo $licencie['nomLicencier'] . ' ' . $licencie['prenomLicencier']
                                    ?>
                                </td>
                                <td><?= $educateur->getEmail(); ?></td>
                                <td><?= $educateur->getEstAdmin() ? "OUI" : "NON"; ?></td>
                                <td>
                                    <a href="edit-educateur-<?= $educateur->getId() ?>" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Modifier</a>
                                    <a href="delete-educateur-<?= $educateur->getId() ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Supprimer</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
